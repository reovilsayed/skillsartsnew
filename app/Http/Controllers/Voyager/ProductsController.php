...
class ProductsController extends Controller
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','product_attributes','categories'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        ProdcatProduct::where('product_id', $id)->delete();
