...
<div id="tf-blog" class="blog-page sec-padding">
  <div class="container">
    <div class="sec-title text-center mb50">
      ...
      <div class="devider"><img src="{{asset('home-page/img/heydarah-icon.png')}}" alt="Heydarah">
    </div>
  </div>
                            ...
                            <div class="single-sidebar-widget popular-post-widget">
                              ...
                              <div class="popular-post-list">
                                        ...
                                        <div class="single-post-list d-flex flex-row align-items-center">
                                          <div class="thumb"> <img class="img-fluid" src="{{Voyager::image($post->image)}}" alt="blog"></div>
                                          <div class="details">
                                             <a href="{{route('post_details',$post->slug)}}" class="transition"><h5>{{$post->title}}</h5> </a> 
                                      ...
                                      <div class="single-sidebar-widget post-category-widget">
                                        ...
                                        <ul class="cat-list">
                                          ...
                                          <li>
                                           <a href="{{route('categoryPost',$category->slug)}}" class="d-flex justify-content-between transition">
