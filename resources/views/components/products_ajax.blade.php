	...
	@foreach($products as $product)
            ...
            <div class="container">
					...
					<a href="{{$product->path()}}" class="card-link">
                        ...
                        <img class="card-img" src="{{Voyager::image($product->thumbnail('small'))}}" alt="Vans">
                   </a>
                        ...
                        <div class="card-body">
                        <h4 class="card-title"><a class="card-link" href="{{$product->path()}}">{{ Str::limit($product->name, $limit = 20, $end = '...')}}</a></h4>
						...
						<div class="row">
                            @if(!$product->is_variable)
							   @if($product->saleprice)
                            <div class="price"><h5 class="priceh5 mt-4 mr-2 ml-2">{{ Shop::price($product->price)}}<del class="ml-2">{{ Shop::price($product->saleprice)}}</del></h5></div>
							@else
							<div class="price"><h5 class="priceh5 mt-4 mr-2 ml-2">{{ Shop::price($product->price)}}</h5></div>
							@endif
							@endif
                            </div>
